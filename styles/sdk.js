/*1530015797,,JIT Construction: v4047105,en_US*/
...
try {
        ...
        (function () {
            ...
            with (this) {
                ...
                __d("ES", ["ES5Array", "ES5ArrayPrototype", "ES5Date", "ES5FunctionPrototype", "ES5Object", "ES5StringPrototype", "ES6Array", "ES6ArrayPrototype", "ES6DatePrototype", "ES6Number", "ES6Object", "ES7ArrayPrototype", "ES7Object", "ES7StringPrototype", "json3"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    __p && __p();
                    var v = {}.toString, w = {"JSON.stringify": u.stringify, "JSON.parse": u.parse};
                    c = {
                        "Array.prototype": h,
                    ...
                    d = {Object: q, "Array.prototype": n, "Date.prototype": o, Number: p, Array: m};
                ...
                __d("JSSDKRuntimeConfig", [], {
                    ...
                    "sdkab": null,
                    "sdkns": "FB",
                    "sdkurl": "http:\/\/connect.facebook.net\/en_US\/sdk.js"
                });
                __d("JSSDKConfig", [], {
                    "bustCache": true,
                    ...
                    "features": {
                        ...
                        "popup_blocker_scribe_logging": {"rate": 0.001},
                        "https_only_enforce_starting": 1538809200,
                        "https_only_learn_more": true
                    },
                    "log_perf": {"rate": 10},
                    "api": {
                        "mode": "warn",
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/xaOI6zd9HW9.js?version=42",
                ...
                __d("sdk.Runtime", ["JSSDKRuntimeConfig", "sdk.Model"], (function (a, b, c, d, e, f, g, h) {
                    __p && __p();
                    var i = {UNKNOWN: 0, PAGETAB: 1, CANVAS: 2, PLATFORM: 4}, j = new h({
                        AccessToken: "",
                        AutoLogAppEvents: !1,
                        ClientID: "",
                        CookieUserID: "",
                ...
                __d("sdk.Content", ["Log", "sdk.domReady", "sdk.UA"], (function (a, b, c, d, e, f, g, h, i) {
                    __p && __p();
                    var j, k = {
                        append: function (a, b) {
                            b || (!j ? (j = b = document.getElementById("fb-root"), b || (g.warn('The "fb-root" div has not been created, auto-creating'), j = b = document.createElement("div"), b.id = "fb-root", i.ie() || !document.body ? h(function () {
                ...
                __d("sdk.Impressions", ["Miny", "QueryString", "UrlMap", "getBlankIframeSrc", "guid", "insertIframe", "sdk.Content", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    __p && __p();
                    ...
                    function o(a) {
                        ...
                        if (c.length > 2e3 && (a.payload && typeof a.payload === "string")) {
                            ...
                            d && d.length < a.payload.length && (a.payload = d, c = h.appendToUrl(b, a))
                        }
                        if (c.length <= 2e3) {
                            d = new Image();
                            d.src = c
                            ...
                            l({
                                url: j(), root: e, name: d, className: "fb_hidden fb_invisible", onload: function () {
                ...
                __d("sdk.Scribe", ["QueryString", "UrlMap", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i) {
                    function a(a, b) {
                        typeof b.extra === "object" && (b.extra.revision = i.getRevision()), new Image().src = g.appendToUrl(h.resolve("www", !0) + "/common/scribe_endpoint.php", {
                            c: a,
                ...
                __d("javascript_shared_TAAL_OpCode", [], (function (a, b, c, d, e, f) {
                    e.exports = ES("Object", "freeze", !1, {PREVIOUS_FILE: 1, PREVIOUS_FRAME: 2, PREVIOUS_DIR: 3})
                }), null);
                ...
                __d("invariant", ["TAAL", "ex", "sprintf"], (function (a, b, c, d, e, f, g, h, i) {
                    ...
                    function a(a, b) {
                        ...
                        if (!a) {
                            var c;
                            if (b === undefined) c = new Error(g.blameToPreviousFrame("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.")); else {
                ...
                __d("Flash", ["sdk.DOMEventListener", "DOMWrapper", "QueryString", "UserAgent_DEPRECATED", "guid", "htmlSpecialChars"], (function (a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                ...
                __d("XDM", ["sdk.DOMEventListener", "DOMWrapper", "Flash", "GlobalCallback", "Log", "UserAgent_DEPRECATED", "emptyFunction", "guid", "wrapFunction"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    __p && __p();
                    ...
                    a = {
                        register: function (a, b) {
                            k.debug("Registering %s as XDM provider", a), q.transports.push(a), p[a] = b
                        }, create: function (a) {
                            __p && __p();
                            ...
                            a.channel || (k.warn("Missing channel name, selecting at random"), a.channel = n());
                            a.whenReady || (a.whenReady = m);
                            a.onMessage || (a.onMessage = m);
                            var b = a.transport || s(a.blacklist || []), c = p[b];
                            if (c && c.isAvailable()) {
                                k.debug("%s is available", b);
                                c.init(a);
                                return b
                            }
                        }
                    ...
                    a.register("flash", function () {
                        ...
                        return {
                            isAvailable: function () {
                                ...
                                __p && __p();
                                k.debug("init flash: " + f.channel);
                                var g = {
                                    send: function (a, c, d, e) {
                                        k.debug("sending to: %s (%s)", c, e), b.postMessage(a, c, e)
                                    }
                                };
                                if (a) {
                                    f.whenReady(g);
                                ...
                                var h = f.root.appendChild(r.document.createElement("div")), l = j.create(function () {
                                    j.remove(l);
                                    clearTimeout(e);
                                    k.info("xdm.swf called the callback");
                                    var a = j.create(function (a, b) {
                                        a = decodeURIComponent(a), b = decodeURIComponent(b), k.debug("received message %s from %s", a, b), f.onMessage(a, b)
                                    }, "xdm.swf:onMessage");
                                    b.init(f.channel, a);
                                    f.whenReady(g)
                                }, "xdm.swf:load");
                                b = i.embed(f.flashUrl, h, null, {
                                ...
                                e = setTimeout(function () {
                                    k.warn("The Flash component did not load within %s ms - verify that the container is not set to hidden or invisible using CSS as this will cause some browsers to not load the components", d)
                                }, d);
                                a = !0
                            }
                        }
                    ...
                    a.register("postmessage", function () {
                        ...
                        return {
                            isAvailable: function () {
                                ...
                                __p && __p();
                                k.debug("init postMessage: " + b.channel);
                                var c = "_FB_" + b.channel, d = {
                                    send: function (a, b, c, d) {
                                        ...
                                        k.debug("sending to: %s (%s)", b, d);
                                        var e = function () {
                                            c.postMessage("_FB_" + d + a, b)
                                        };
                                        l.ie() == 8 || l.ieCompatibilityMode() ? setTimeout(e, 0) : e()
                                    }
                                };
                                if (a) {
                                    b.whenReady(d);
                                ...
                                g.add(r, "message", o(function (event) {
                                    ...
                                    if (!/^(https?:\/\/|native$)/.test(d)) {
                                        k.debug("Received message from invalid origin type: %s", d);
                                        return
                                    }
                                    if (d !== "native" && !(t.test(location.hostname) || t.test(event.origin))) return;
                                    if (typeof a !== "string") {
                                        k.warn("Received message of type %s from %s, expected a string", typeof a, d);
                                        return
                                    }
                                    k.debug("received message %s from %s", a, d);
                ...
                __d("hasNamePropertyBug", ["UserAgent_DEPRECATED", "guid"], (function (a, b, c, d, e, f, g, h) {
                    __p && __p();
                ...
                __d("sdk.createIframe", ["sdk.DOMEventListener", "getBlankIframeSrc", "guid", "hasNamePropertyBug", "isNumberLike"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                ...
                __d("sdk.XD", ["JSSDKXDConfig", "Log", "QueryString", "Queue", "UrlMap", "XDM", "guid", "isFacebookURI", "sdk.Content", "sdk.createIframe", "sdk.Event", "sdk.feature", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    __p && __p();
                    var w = new j(), x = new j(), y = new j(), z, A, B = m();
                    a = g.useCdn ? "cdn" : "www";
                    b = r("use_bundle", !1) ? g.XdBundleUrl : g.XdUrl;
                    var C = k.resolve(a, !1) + b, D = k.resolve(a, !0) + b;
                    c = function () {
                    ...
                    var E = m(), F = c(), G, H = !1, I = "Facebook Cross Domain Communication Frame", J = {},
                        K = new j();
                    s.setInQueue(K);

                    function L(a) {
                        h.info("Remote XD can talk to facebook.com (%s)", a), t.setEnvironment(a === "canvas" ? t.ENVIRONMENTS.CANVAS : t.ENVIRONMENTS.PAGETAB)
                    }
                    ...
                    function M(a, b) {
                        ...
                        switch (a.xd_action) {
                            case"proxy_ready":
                                var d, e;
                                c == "https" ? (d = y, e = A, t.setLoggedIntoFacebook(a.logged_in === "true")) : (d = x, e = z);
                                a.registered && (L(a.registered), w = d.merge(w));
                                h.info("Proxy ready, starting queue %s containing %s messages", c + "ProxyQueue", d.getLength());
                                d.start(function (a) {
                                    G.send(typeof a === "string" ? a : i.encode(a), b, e.contentWindow, E + "_" + c)
                                });
                                break;
                            case"plugin_ready":
                                h.info("Plugin %s ready, protocol: %s", a.name, c);
                                J[a.name] = {protocol: c};
                                if (j.exists(a.name)) {
                                    d = j.get(a.name);
                                    h.debug("Enqueuing %s messages for %s in %s", d.getLength(), a.name, c + "ProxyQueue");
                                    (c == "https" ? y : x).merge(d)
                                }
                                break
                        }
                    ...
                    function N(a, b) {
                        ...
                        a.access_token && t.setSecure(/^https/.test(F));
                        if (a.cb) {
                            b = Q._callbacks[a.cb];
                    ...
                    function O(a, b) {
                        if (a == "facebook") b.relation = "parent.parent", w.enqueue(b); else {
                            ...
                            var c = J[a];
                            c ? (h.debug("Enqueuing message for plugin %s in %s", a, c.protocol + "ProxyQueue"), (c.protocol == "https" ? y : x).enqueue(b)) : (h.debug("Buffering message for plugin %s", a), j.get(a).enqueue(b))
                        }
                    }
                    ...
                    function P(a) {
                        __p && __p();
                        if (H) return;
                        var b = o.appendHidden(document.createElement("div")), c = l.create({
                            blacklist: null,
                            root: b,
                            channel: E,
                ...
                __d("sdk.Auth", ["sdk.Cookie", "sdk.createIframe", "DOMWrapper", "sdk.feature", "sdk.getContextType", "guid", "sdk.Impressions", "Log", "ObservableMixin", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "UrlMap", "sdk.URI", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    __p && __p();
                    var v = "fblo_", w = 365 * 24 * 60 * 60 * 1e3, x, y = null, z, A = new o();

                    function B(a, b, c) {
                        __p && __p();
                        c === void 0 && (c = null);
                        var d = p.getUserID(), e = "";
                        if (a) if (a.userID) e = a.userID; else if (a.signedRequest) {
                            var f = r.parse(a.signedRequest);
                            f && f.user_id && (e = f.user_id)
                        }
                        f = p.getLoginStatus();
                        var g = f === "unknown" && a || p.getUseCookie() && p.getCookieUserID() !== e, h = d && !a;
                        d = a && d && d != e;
                        var i = a != x;
                        f = b != (f || "unknown");
                        p.setLoginStatus(b);
                        ...
                        p.setUserID(e);
                        x = a;
                        e = {authResponse: a, status: b};
                        c === null ? y = null : (y = c, e.userID = c);
                        (h || d) && A.inform("logout", e);
                        (g || d) && A.inform("login", e);
                        i && A.inform("authresponse.change", e);
                        f && A.inform("status.change", e);
                        return e
                    }
                    ...
                    function E(a, b, c) {
                        ...
                        return function (d) {
                            ...
                            if (d && d.access_token) {
                                ...
                                f = "connected";
                                B(b, f)
                            } else (c === "logout" || c === "login_status") && (d.error && d.error === "not_authorized" ? (f = "not_authorized", B(null, f)) : d.error && d.error === "authorization_expired" ? (f = "authorization_expired", B(null, f, d.expired_user_id)) : (f = "unknown", B(null, f)), p.getUseCookie() && g.clearSignedRequestCookie(), c === "logout" && (G(), q.log("jssdk_error", {
                                appId: p.getClientID(),
                            ...
                            if (a) {
                                e = {authResponse: b, status: p.getLoginStatus()};
                                f = D();
                                f && (e.userID = f);
                                a(e)
                            }
                    ...
                    function a(b, c) {
                        ...
                        if (b) if (!c && I == "loaded") {
                            var d = {authResponse: C(), status: p.getLoginStatus()}, a = D();
                            a && (d.userID = a);
                            b(d);
                            return
                        } else A.subscribe("FB.loginStatus", b);
                        if (!c && I == "loading") return;
                        I = "loading";
                        a = function (a) {
                            I = "loaded", A.inform("FB.loginStatus", a), A.clearSubscribers("FB.loginStatus")
                        };
                        H(a)
                    }
                ...
                __d("sdk.DOM", ["Assert", "sdk.domReady", "sdk.UA"], (function (a, b, c, d, e, f, g, h, i) {
                    __p && __p();
                    var j = {};
                ...
                __d("sdk.ErrorHandling", ["sdk.ErrorHandler", "sdk.feature", "sdk.Runtime", "sdk.Scribe"], (function (a, b, c, d, e, f, g, h, i, j) {
                    a = h("error_handling", !1);
                    e.exports = g.create(a, function (a) {
                        j.log("jssdk_error", {appId: i.getClientID(), error: a.name || a.message, extra: a})
                    })
                }), null);
                __d("sdk.Insights", ["sdk.Impressions"], (function (a, b, c, d, e, f, g) {
                    a = {
                        TYPE: {NOTICE: "notice", WARNING: "warn", ERROR: "error"},
                        CATEGORY: {DEPRECATED: "deprecated", APIERROR: "apierror", HTTP_DEPRECATED: "httpdeprecated"},
                        log: function (a, b, c) {
                ...
                __d("FB", ["DOMWrapper", "GlobalCallback", "JSSDKConfig", "JSSDKCssConfig", "Log", "dotAccess", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.domReady", "sdk.ErrorHandling", "sdk.feature", "sdk.Insights", "sdk.Runtime", "sdk.Scribe"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    __p && __p();
                    var v, w, x = l(i, "api.mode"), y, z = l(i, "features.https_only_enforce_starting"),
                        A = l(i, "features.https_only_learn_more", ""), B = {};
                    v = window.FB = {};
                    b = {};
                    k.level = 0;
                    ...
                    g.setRoot(C);
                    p(function () {
                        k.info("domReady"), n.appendHidden(C), j.rules && o.addCssRules(j.rules, j.components)
                    });
                    t.subscribe("AccessToken.change", function (a) {
                        !a && t.getLoginStatus() === "connected" && m.getLoginStatus(null, !0)
                    });
                    l(i, "api.whitelist.length") && (w = {}, ES(i.api.whitelist, "forEach", !0, function (a) {
                        w[a] = 1
                    }));
                    l(i, "api.https_only.length") && (y = {}, ES(i.api.https_only, "forEach", !0, function (a) {
                        y[a] = 1
                    }));
                    ...
                    function D(a, b, c, d) {
                        ...
                        switch (e) {
                            ...
                            case"stub":
                                return function () {
                                    k.warn("The method FB.%s has been removed from the JS SDK.", b)
                                };
                            default:
                                return location.protocol !== "https:" && y && y[b] && z && z - ES("Date", "now", !1) <= 0 ? function () {
                                    k.error("The method FB.%s can no longer be called from http pages. %s", b, A)
                                } : q.guard(function () {
                                    __p && __p();
                                    if (location.protocol !== "https:" && y && y[b] && z) {
                                        var f = Math.floor((z - ES("Date", "now", !1)) / 864e5) + 1;
                                        f > 30 ? k.warn("The method FB.%s will stop working when called from http pages in %s days.  Please update your site to use https for Facebook Login. %s", b, Math.floor((z - ES("Date", "now", !1)) / 864e5), A) : k.error("The method FB.%s will stop working when called from http pages in %s days.  Please update your site to use https for Facebook Login. %s", b, Math.floor((z - ES("Date", "now", !1)) / 864e5), A);
                                        r("https_only_scribe_logging", !0) && !Object.prototype.hasOwnProperty.call(B, b) && (u.log("jssdk_error", {
                                            appId: t.getClientID(),
                                            error: "HttpsOnly method called from http",
                                            extra: {message: b}
                                        }), B[b] = !0)
                                    }
                                    e === "warn" && (k.warn("The method FB.%s is not officially supported by Facebook and access to it will soon be removed.", b), Object.prototype.hasOwnProperty.call(B, b) || (s.log(s.TYPE.WARNING, s.CATEGORY.DEPRECATED, "FB." + b), u.log("jssdk_error", {
                                        appId: t.getClientID(),
                                    ...
                                    function g(a) {
                                        if (ES("Array", "isArray", !1, a)) return ES(a, "map", !0, g);
                                        return a && typeof a === "object" && a.__wrapped ? a.__wrapped : typeof a === "function" && /^function/.test(a.toString()) ? q.unguard(a) : a
                                    }

                                    var h = ES(Array.prototype.slice.call(arguments), "map", !0, g), i = a.apply(d, h),
                                        j, l = !0;
                                    if (i && typeof i === "object") {
                                        ...
                                        for (var c in i) {
                                            var m = i[c];
                                            if (typeof m !== "function" || c === "constructor") continue;
                                            l = !1;
                                            j[c] = D(m, b + ":" + c, c, i)
                                        }
                                    }
                ...
                __d("ApiClientUtils", ["ArgumentError", "Assert", "Log", "flattenObject", "sdk.URI", "sprintf"], (function (a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                ...
                __d("CORSRequest", ["QueryString", "RequestConstants", "sdk.safelyParseResponse", "wrapFunction"], (function (a, b, c, d, e, f, g, h, i, j) {
                    __p && __p();
                    ...
                    function k(a, b) {
                        ...
                        }, "entry", "XMLHttpRequest:load"), g = j(function () {
                    ...
                    function a(a, b, c, d) {
                        ...
                        b.onerror = function (b) {
                            b.responseText ? d(i(b.responseText, a)) : d({error: babelHelpers["extends"]({}, h.PARSE_ERROR_TEMPLATE, {status: b.status})})
                        };
                        b.send(c);
                        return !0
                    }
                ...
                __d("ChunkedRequest", ["GraphBatchConstants", "QueryString", "RequestConstants", "sdk.safelyParseResponse", "wrapFunction"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    ...
                    function m(a) {
                        a === void 0 && (a = g.FLUSH_DELIMITER), this.offset = 0, this.delimiter = g.FLUSH_DELIMITER, this.delimiter = a
                    }

                    m.prototype.parse = function (a, b) {
                        __p && __p();
                        b === void 0 && (b = !1);
                        var c = [], d = a.substring(this.offset), e = 0, f = ES(d, "indexOf", !0, this.delimiter, e);
                ...
                __d("ApiClient", ["ApiBatcher", "ApiClientConfig", "ApiClientUtils", "Assert", "ChunkedRequest", "CORSRequest", "FlashRequest", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "UrlMap", "flattenObject"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
                    __p && __p();
                    ...
                    function G() {
                        for (var a = arguments.length, b = new Array(a), c = 0; c < a; c++) b[c] = arguments[c];
                        var d = i.parseCallDataFromArgs(b), e = d.uri, f = d.callback, g = d.params, h = g.method;
                        I(e, h) && (h = "post");
                        var j = e.getProtocol() && e.getDomain() ? e.setQueryData({}).toString() : r.resolve("graph") + e.getPath(),
                            k = C++;
                        H.inform("request.prepare", j, g, k);
                        E(j, h == "get" ? "get" : "post", g, ES(F, "bind", !0, null, f, e.getPath(), h, g, ES("Date", "now", !1), k))
                    }
                ...
                __d("sdk.PlatformVersioning", ["ManagedError", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h) {
                    var i = /^v\d+\.\d\d?$/;
                    a = {
                        REGEX: i, assertVersionIsSet: function () {
                            if (!h.getVersion()) throw new g("init not called with valid version")
                ...
                __d("sdk.api", ["ApiClient", "sdk.feature", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.Scribe", "sdk.URI"], (function (a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                    var m = h("should_log_response_error", !1), n;
                    ...
                    g.subscribe("request.complete", function (a, b, c, d) {
                        (a == "/me/permissions" && b === "delete" || a == "/restserver.php" && c.method == "Auth.revokeAuthorization") && d === !0 && j.setAccessToken(null)
                    });
                    g.subscribe("request.error", function (a, b, c, d) {
                        m && d.error.type === "http" && k.log("jssdk_error", {
                            appId: j.getClientID(),
                            error: "transport",
                    ...
                    function a(a) {
                        __p && __p();
                        if (typeof a === "string") if (j.getIsVersioned()) {
                            i.assertVersionIsSet();
                            !/https?/.test(a) && a.charAt(0) !== "/" && (a = "/" + a);
                            a = new l(a).setDomain(null).setProtocol(null).toString();
                            i.REGEX.test(a.substring(1, ES(a, "indexOf", !0, "/", 1))) || (a = "/" + j.getVersion() + a);
                ...
                __d("sdk.AppEvents", ["AppUserPropertyAPIBuiltinField", "Assert", "FBAppEvents", "sdk.Auth", "sdk.Event", "sdk.Impressions", "sdk.Model", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    __p && __p();
                    var o = ES("Object", "freeze", !1, {
                        ...
                        y = 100, z = ES("Object", "values", !1, g), A = new m({UserID: "", Version: ""});

                    function B(a, b, c, d) {
                        b = {ae: 1, ev: b, vts: c, canvas: 1};
                        d && (b.cd = d);
                        l.impression({api_key: a, payload: ES("JSON", "stringify", !1, b)})
                    }

                    function C(a, b, c, d) {
                        var e = j.getAuthResponse();
                        e = e && e.accessToken ? e.accessToken : null;
                        i.logEvent(a, b, d || {}, c, e)
                    }
                    ...
                    function D(a, b, c, d) {
                        ...
                        n.isCanvasEnvironment() ? B(a, b, c, d) : C(a, b, c, d)
                    }
                    ...
                    function M(a, b, c) {
                        ...
                        G(d);
                        L(b);
                        i.updateUserProperties(d, a, b, c)
                    }

                    k.subscribe("init:post", function (a) {
                        n.getClientID() && (a.autoLogAppEvents !== undefined && (h.isBoolean(a.autoLogAppEvents, "Type of property autoLogAppEvents must be boolean"), n.setAutoLogAppEvents(a.autoLogAppEvents)), n.getAutoLogAppEvents() && F(n.getClientID()))
                    });
                    e.exports = {
                        activateApp: b,
                        logEvent: D,
                ...
                __d("sdk.DialogUtils", ["sdk.Content", "sdk.DOM", "sdk.DOMEventListener", "sdk.UA"], (function (a, b, c, d, e, f, g, h, i, j) {
                    "use strict";
                    __p && __p();
                    a = {
                        isOrientationPotrait: function () {
                            ...
                            f < g && (g = f);
                            var i = e.height - d - g, k = (e.height - d) / 2;
                            c && (k = c.scrollTop - c.offsetTop + (c.clientHeight - d) / 2);
                            k < g ? k = g : k > i && (k = i);
                            k += e.scrollTop;
                            if (j.mobile()) {
                                c = 100;
                                b ? (c += (e.height - d) / 2, h.addCss(document.body, "fb_reposition")) : (h.addCss(document.body, "fb_hidden"), document.body.style.width = "auto", k = 1e4);
                ...
                __d("sdk.Dialog", ["ObservableMixin", "Type", "sdk.Canvas.Environment", "sdk.Content", "sdk.DialogUtils", "sdk.DOM", "sdk.DOMEventListener", "sdk.fbt", "sdk.Runtime", "sdk.UA"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
                    __p && __p();
                    var q = 30, r = 590, s = 500, t = 240, u = 575;

                    function v() {
                        var a = l.getViewportInfo();
                        return a.height && a.width ? {width: Math.min(a.width, s), height: Math.min(a.height, r)} : null
                    }

                    var w = h.extend({
                        constructor: function (a, b) {
                            this.parent(), this.id = a, this.display = b, this._e2e = {}, x._dialogs || (x._dialogs = {}, x._addOrientationHandler()), x._dialogs[a] = this, this.trackEvent("init")
                        ...
                        _createMobileLoader: function () {
                            var a;
                            p.nativeApp() ? a = '<div class="dialog_header"></div>' : x.isTabletStyle() ? a = '<div class="overlayLoader"><div id="fb_dialog_loader_spinner"></div><a id="fb_dialog_loader_close" href="#">' + n._("Cancel") + "</a></div>" : a = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + n._("Cancel") + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + n._("Loading...") + '        </div>      </td>      <td class="header_right">      </td>    </tr>  </tbody></table></div>';
                            return x.create({classes: "loading" + (x.isTabletStyle() ? " centered" : ""), content: a})
                        },
                        ...
                        _showTabletOverlay: function (a) {
                            ...
                            x._overlayEl || (x._overlayEl = k.setupNewDarkOverlay(), j.append(x._overlayEl, null));
                            if (x._closeOnOverlayTap) {
                                a = k.addDoubleClickAction(x._overlayEl, ES(a, "bind", !0, this), 5e3);
                                x._overlayListeners.push(a)
                            }
                            x._overlayEl.className = ""
                        },
                        _hideTabletOverlay: function () {
                            x.isTabletStyle() && (x._overlayEl.className = "hidden", ES(x._overlayListeners, "forEach", !0, function (a) {
                                return a.remove()
                            }), x._overlayListeners = [])
                        },
                        showLoader: function (a, b) {
                            ...
                            var c = function () {
                                x._hideLoader(), k.onDialogHideCleanup(x.isTabletStyle()), x._hideTabletOverlay(), a()
                            };
                            x._showTabletOverlay(c);
                            x._loaderEl || (x._loaderEl = x._findRoot(p.mobile() ? x._createMobileLoader() : x._createWWWLoader(b)));
                        ...
                        _hideLoader: function () {
                            x._loaderEl && x._loaderEl == x._active && (x._loaderEl.style.top = "-10000px")
                        },
                        _makeActive: function (a) {
                            x._setDialogSizes(), x._lowerActive(), x._active = a, o.isEnvironment(o.ENVIRONMENTS.CANVAS) && i.getPageInfo(function (a) {
                                x._centerActive(a)
                            }), x._centerActive()
                        },
                        ...
                        _centerActive: function (a) {
                            var b = x._active;
                            if (!b) return;
                            x._positionDialogAtTopWhenPortrait && k.isOrientationPotrait() ? k.setDialogPositionToTop(b, x.isTabletStyle(), a) : k.setDialogPositionToCenter(b, x.isTabletStyle(), a)
                        },
                        _setDialogSizes: function (a) {
                            a === void 0 && (a = !1);
                            if (!p.mobile()) return;
                            for (var b in x._dialogs) if (Object.prototype.hasOwnProperty.call(x._dialogs, b)) {
                                var c = document.getElementById(b);
                                c && (c.style.width = x.getDefaultSize().width + "px", a || (c.style.height = x.getDefaultSize().height + "px"))
                            }
                        },
                        getDefaultSize: function () {
                            ...
                            if (p.mobile()) {
                                var a = v();
                                if (a) {
                                    l.getViewportInfo().width <= a.width && (a.width = l.getViewportInfo().width - q);
                                    l.getViewportInfo().height <= a.height && (a.height = l.getViewportInfo().height - q);
                                    return a
                                }
                        ...
                        _handleOrientationChange: function () {
                            ...
                            if (x.isTabletStyle()) x._setDialogSizes(!0), x._centerActive(), x._setDialogOverlayStyle(); else {
                        ...
                        _addOrientationHandler: function () {
                            ...
                            x._availScreenWidth = l.getViewportInfo().width;
                            k.addMobileOrientationChangeAction(x._handleOrientationChange)
                        },
                        create: function (a) {
                        ...
                        show: function (a) {
                            var b = x._findRoot(a);
                            b && (x._removeStacked(b), x._hideLoader(), x._makeActive(b), x._stack.push(b), "fbCallID" in a && x.get(a.fbCallID).inform("iframe_show").trackEvent("show"))
                        },
                        hide: function (a) {
                            var b = x._findRoot(a);
                            x._hideLoader();
                            b == x._active && (x._lowerActive(), k.onDialogHideCleanup(x.isTabletStyle()), x._hideTabletOverlay(), "fbCallID" in a && x.get(a.fbCallID).inform("iframe_hide").trackEvent("hide"))
                        },
                        remove: function (a) {
                            a = x._findRoot(a);
                            if (a) {
                                var b = x._active == a;
                                x._removeStacked(a);
                                b ? (x._hideLoader(), x._stack.length > 0 ? x.show(x._stack.pop()) : (x._lowerActive(), k.onDialogHideCleanup(x.isTabletStyle()), x._hideTabletOverlay())) : x._active === null && x._stack.length > 0 && x.show(x._stack.pop());
                                setTimeout(function () {
                ...
                __d("sdk.NativeExtensions", ["Log", "sdk.DOMEventListener", "sdk.domReady", "sdk.UA"], (function (a, b, c, d, e, f, g, h, i, j) {
                    __p && __p();
                ...
                __d("sdk.Extensions", ["JSONRPC", "Queue", "sdk.NativeExtensions", "sdk.UA"], (function (a, b, c, d, e, f, g, h, i, j) {
                    "use strict";
                    __p && __p();
                    ...
                    var n = null;
                    j.facebookInAppBrowser() && i.onReady(function (a) {
                        n = a;
                        if (a) {
                            var b = a;
                ...
                __d("sdk.Frictionless", ["sdk.api", "sdk.Auth", "sdk.Dialog", "sdk.Event"], (function (a, b, c, d, e, f, g, h, i, j) {
                    __p && __p();
                    var k = {
                        _allowedRecipients: {}, _useFrictionless: !1, _updateRecipients: function () {
                            k._allowedRecipients = {}, g("/me/apprequestformerrecipients", function (a) {
                                if (!a || a.error) return;
                            ...
                            k._useFrictionless = !0, h.getLoginStatus(function (a) {
                            ...
                            return function (c) {
                                ...
                                c && (!b && c.frictionless && (i._hideLoader(), i._restoreBodyPosition(), i._hideIPadOverlay()), delete c.frictionless, delete c.updated_frictionless);
                                a && a(c)
                            }
                        }, isAllowed: function (a) {
                            __p && __p();
                ...
                __d("sdk.UIServer", ["JSSDKConfig", "Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.Auth", "sdk.Content", "sdk.Dialog", "sdk.DOM", "sdk.Event", "sdk.Extensions", "sdk.fbt", "sdk.feature", "sdk.Frictionless", "sdk.getContextType", "sdk.Native", "sdk.openMessenger", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.UA", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F) {
                    ...
                    var G = {
                        transform: function (a) {
                            if (a.params.display === "touch" && L.canIframe(a.params) && window.postMessage) {
                                a.params.channel = L._xdChannelHandler(a.id, "parent");
                                E.nativeApp() || (a.params.in_iframe = 1);
                                return a
                            } else return L.genericTransform(a)
                        }, getXdRelation: function (a) {
                            var b = a.display;
                            return b === "touch" && window.postMessage && a.in_iframe ? "parent" : L.getXdRelation(a)
                        }
                    };
                    ...
                    a = {
                        ...
                        apprequests: {
                            transform: function (a) {
                                ...
                                a.params.frictionless && (x.isAllowed(a.params.to) && (a.params.display = "iframe", a.params.in_iframe = !0, a.hideLoader = !0), a.cb = x._processRequestResponse(a.cb, a.hideLoader));
                                a.closeIcon = !1;
                                return a
                        ...
                        "permissions.oauth": {
                            url: "dialog/oauth",
                            size: {width: E.mobile() ? null : 475, height: E.mobile() ? null : 183},
                            transform: function (a) {
                                __p && __p();
                                if (!C.getClientID()) {
                                ...
                                if (p.getAuthResponse() && !a.params.scope && !a.params.auth_type) {
                                    h.error("FB.login() called when user is already connected.");
                                    a.cb && a.cb({status: C.getLoginStatus(), authResponse: p.getAuthResponse()});
                                    return
                                }
                                var b = a.cb, c = a.id;
                                delete a.cb;
                                var d = a.params.auth_type === "reauthenticate",
                                    e = ES("Object", "keys", !1, ES("Object", "assign", !1, a.params.response_type ? k(a.params.response_type.split(",")) : {}, {
                                        token: !0,
                                        signed_request: !0
                                    })).join(",");
                                a.params.display === "async" ? (ES("Object", "assign", !1, a.params, {
                                    ...
                                    response_type: e,
                                    domain: location.hostname
                                }), a.cb = p.xdResponseWrapper(b, p.getAuthResponse(), "permissions.oauth")) : (d && L._xdNextHandler(function (a) {
                                    b({authResponse: null, status: "not_authorized"})
                                }, c, "opener", !0), ES("Object", "assign", !1, a.params, {
                                    client_id: C.getClientID(),
                                    redirect_uri: o(L.xdHandler(b, c, "opener", p.getAuthResponse(), "permissions.oauth", !d)),
                                    origin: y(),
                                    response_type: e,
                                    domain: location.hostname
                                }));
                        ...
                        "auth.logout": {
                            url: "logout.php", transform: function (a) {
                                if (!C.getClientID()) h.error("FB.logout() called before calling FB.init()."); else if (!p.getAuthResponse()) h.error("FB.logout() called without an access token."); else {
                                    a.params.next = L.xdHandler(a.cb, a.id, "parent", p.getAuthResponse(), "logout", !0);
                                    return a
                                }
                            }
                        },
                        "login.status": {
                            url: "dialog/oauth", transform: function (a) {
                                ...
                                ES("Object", "assign", !1, a.params, {
                                    client_id: C.getClientID(),
                                    redirect_uri: L.xdHandler(b, c, "parent", p.getAuthResponse(), "login_status", !0),
                                    origin: y(),
                                    response_type: "token,signed_request,code",
                                    domain: location.hostname
                                });
                    ...
                    var L = {
                        ...
                        genericTransform: function (a) {
                            (a.params.display == "dialog" || a.params.display == "iframe") && ES("Object", "assign", !1, a.params, {
                                display: "iframe",
                                channel: L._xdChannelHandler(a.id, "parent.parent")
                            }, !0);
                            return a
                        },
                        checkOauthDisplay: function (a) {
                            ...
                            b = b.split(/\s|,/g);
                            for (var c = 0; c < b.length; c++) if (!g.initSitevars.iframePermissions[ES(b[c], "trim", !0)]) return "popup";
                            return a.display
                        },
                        prepareCall: function (a, b) {
                            __p && __p();
                            var c = a.method.toLowerCase(),
                                d = Object.prototype.hasOwnProperty.call(L.Methods, c) ? ES("Object", "assign", !1, {}, L.Methods[c]) : {},
                                e = m(), f = C.getSecure() || c !== "auth.status" && c != "login.status";
                            ES("Object", "assign", !1, a, {
                            ...
                            (c === "share" || c === "share_open_graph") && (a.mobile_iframe = E.mobile() && (a.mobile_iframe || a.iframe_test), a.mobile_iframe && (d = ES("Object", "assign", !1, {}, G)));
                            a.display = L.getDisplayMode(d, a);
                            d.url || (d.url = "dialog/" + c);
                            (d.url == "dialog/oauth" || d.url == "dialog/permissions.request") && (a.display == "iframe" || a.display == "touch" && a.in_iframe) && (a.display = L.checkOauthDisplay(a));
                            a.display == "popup" && !d.require_access_token && delete a.access_token;
                            C.getIsVersioned() && d.url.substring(0, 7) === "dialog/" && (d.url = a.version + "/" + d.url);
                            if (K(a)) {
                                if (I[c]) {
                            ...
                            g = {
                                cb: b,
                                id: e,
                                size: d.size || L.getDefaultSize(),
                                url: j.resolve(a.display == "touch" ? "m" : "www", f) + "/" + d.url,
                                params: a,
                                name: c,
                                dialog: r.newInstance(e, a.display)
                            };
                            b = d.transform ? d.transform : L.genericTransform;
                            if (b) {
                                g = b(g);
                                if (!g) return
                            }
                            a.display === "touch" && a.in_iframe && (g.params.parent_height = window.innerHeight);
                            f = d.getXdRelation || L.getXdRelation;
                            c = f(g.params);
                            !(g.id in L._defaultCb) && !("next" in g.params) && !("redirect_uri" in g.params) && (g.params.next = L._xdResult(g.cb, g.id, c, !0));
                            (c === "parent" || c === "opener") && ES("Object", "assign", !1, g.params, {channel_url: L._xdChannelHandler(e, c === "parent" ? "parent.parent" : "opener")}, !0);
                            g = L.prepareParams(g);
                            return g
                        },
                        prepareParams: function (a) {
                            a.params.display !== "async" && delete a.params.method;
                            a.params.kid_directed_site = C.getKidDirectedSite() || a.params.kid_directed_site;
                            a.params = l(a.params);
                            var b = i.encode(a.params);
                            !E.nativeApp() && L.urlTooLongForIE(a.url + "?" + b) ? a.post = !0 : b && (a.url += "?" + b);
                            return a
                        },
                        ...
                        getDisplayMode: function (a, b) {
                            ...
                            var c = C.isEnvironment(C.ENVIRONMENTS.CANVAS) || C.isEnvironment(C.ENVIRONMENTS.PAGETAB);
                            if (c && !b.display) return "async";
                            if (H(b) && u.supportsDialog("oauth")) return "async";
                            if (E.mobile() || b.display === "touch") return "touch";
                            if ((b.display == "iframe" || b.display == "dialog") && !L.canIframe(b)) {
                                h.error('"dialog" mode can only be used when the user is connected.');
                                return "popup"
                            }
                            return a.connectDisplay && !c ? a.connectDisplay : b.display || (L.canIframe(b) ? "dialog" : "popup")
                        },
                        canIframe: function (a) {
                            if (C.getAccessToken()) return !0;
                            return E.mobile() && C.getLoggedIntoFacebook() ? !!a.mobile_iframe : !1
                        },
                        getXdRelation: function (a) {
                            a = a.display;
                        ...
                        popup: function (a) {
                            ...
                            var b = typeof window.screenX !== "undefined" ? window.screenX : window.screenLeft,
                                ...
                                f = E.mobile() ? null : a.size.width, g = E.mobile() ? null : a.size.height;
                            ...
                            c.push("top=" + d);
                            c.push("scrollbars=1");
                            (a.name == "permissions.request" || a.name == "permissions.oauth") && (c.push("toolbar=0"), (!E.chrome() || E.chrome() < 59) && c.push("location=1"));
                            c = c.join(",");
                            a.post ? (e = window.open("about:blank", a.id, c), e && (L.setLoadedNode(a, e, "popup"), q.submitToTarget({
                                url: a.url,
                                target: a.id,
                                params: a.params
                            }))) : (e = window.open(a.url, a.id, c), e && L.setLoadedNode(a, e, "popup"));
                            if (!e) {
                                w("popup_blocker_scribe_logging", !0) && D.log("jssdk_error", {
                                    appId: C.getClientID(),
                            ...
                            a.id in L._defaultCb && L._popupMonitor()
                        },
                        ...
                        hidden: function (a) {
                            a.className = "FB_UI_Hidden", a.root = q.appendHidden(""), L._insertIframe(a)
                        },
                        iframe: function (a) {
                            __p && __p();
                            a.className = "FB_UI_Dialog";
                            a.params.mobile_iframe && (r.setForceTabletStyle(!0), r.setCloseOnOverlayTap(!0), r.setPositionDialogAtTopWhenPortrait(!0));
                            var b = function () {
                                var b = ES("JSON", "stringify", !1, {
                                    error_code: 4201,
                                    error_message: v._("User canceled the Dialog flow")
                                });
                                L._triggerDefault(a.id, b)
                            }, c = {
                                onClose: b,
                        ...
                        touch: function (a) {
                            a.params && a.params.in_iframe ? a.ui_created ? r.showLoader(function () {
                                L._triggerDefault(a.id, null)
                            }, 0) : L.iframe(a) : E.nativeApp() && !a.ui_created ? (a.frame = a.id, z.onready(function () {
                                L.setLoadedNode(a, z.open(a.url + "#cb=" + a.frameName), "native")
                            }), L._popupMonitor()) : a.ui_created || L.popup(a)
                        },
                        async: function (a) {
                            __p && __p();
                            ...
                            H(a.params) && u.supportsDialog("oauth") ? (a.params.method = "oauth", a.params.redirect_uri = a.params.next, u.remote.showDialog(a.params, b)) : B.remote.showDialog(a.params, b)
                        },
                        "native": function (a) {
                            A(a.params)
                        },
                        ...
                        _insertIframe: function (a) {
                            L._loadedNodes[a.id] = !1;
                            var b = function (b) {
                                a.id in L._loadedNodes && L.setLoadedNode(a, b, "iframe")
                            };
                            a.post ? n({
                                url: "about:blank",
                                root: a.root,
                                ...
                                onInsert: b,
                                onload: function (b) {
                                    q.submitToTarget({url: a.url, target: b.name, params: a.params})
                                }
                            }) : n({
                                url: a.url,
                                root: a.root,
                        ...
                        _handleResizeMessage: function (a, b) {
                            ...
                            F.inform("resize.ack", b || {}, "parent.frames[" + a.name + "]");
                            !r.isActive(a) ? r.show(a) : r._centerActive()
                        },
                        _triggerDefault: function (a, b) {
                            var c = {frame: a};
                            b && (c.result = b);
                            L._xdRecv(c, L._defaultCb[a] || function () {
                            })
                        },
                        _popupMonitor: function () {
                            __p && __p();
                            var a;
                            for (var b in L._loadedNodes) if (Object.prototype.hasOwnProperty.call(L._loadedNodes, b) && b in L._defaultCb) {
                                var c = L._loadedNodes[b];
                                if (c.type != "popup" && c.type != "native") continue;
                                c = c.node;
                                try {
                                    c.closed ? L._triggerDefault(b, null) : a = !0
                                } catch (a) {
                                }
                            }
                            a && !L._popupInterval ? L._popupInterval = setInterval(L._popupMonitor, 100) : !a && L._popupInterval && (clearInterval(L._popupInterval), L._popupInterval = null)
                        },
                        _xdChannelHandler: function (a, b) {
                            __p && __p();
                            return F.handler(function (b) {
                                __p && __p();
                                var c = L.getLoadedNode(a);
                                if (!c) return;
                                if (b.type == "resize") L._handleResizeMessage(a, b); else if (b.type == "hide") r.hide(c); else if (b.type == "rendered") {
                                    c = r._findRoot(c);
                                    r.show(c)
                        ...
                        _xdRecv: function (a, b) {
                            __p && __p();
                            var c = L.getLoadedNode(a.frame);
                            if (c) if (c.close) try {
                                c.close(), /iPhone.*Version\/(5|6)/.test(navigator.userAgent) && RegExp.$1 !== "5" && window.focus(), L._popupCount--
                            } catch (a) {
                            } else s.containsCss(c, "FB_UI_Hidden") ? setTimeout(function () {
                                c.parentNode.parentNode.removeChild(c.parentNode)
                            }, 3e3) : s.containsCss(c, "FB_UI_Dialog") && r.remove(c);
                            delete L._loadedNodes[a.frame];
                            delete L._defaultCb[a.frame];
                            if (a.e2e) {
                                var d = r.get(a.frame);
                                d.trackEvents(a.e2e);
                                d.trackEvent("close");
                        ...
                        _xdResult: function (a, b, c, d) {
                            return L._xdNextHandler(function (b) {
                                a && a(b.result && b.result != L._resultToken && ES("JSON", "parse", !1, b.result))
                            }, b, c, d) + "&result=" + encodeURIComponent(L._resultToken)
                        },
                        xdHandler: function (a, b, c, d, e, f) {
                            return L._xdNextHandler(p.xdResponseWrapper(a, d, e), b, c, f)
                        }
                    };
                    u.stub("showDialog");
                    B.stub("showDialog");
                ...
                __d("sdk.ui", ["Assert", "Log", "sdk.feature", "sdk.Impressions", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UIServer"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    __p && __p();
                    ...
                    function a(a, b) {
                        ...
                        g.isObject(a);
                        g.maybeFunction(b);
                        l.getIsVersioned() && (k.assertVersionIsSet(), a.version ? k.assertValidVersion(a.version) : a.version = l.getVersion());
                        a = ES("Object", "assign", !1, {}, a);
                        if (!a.method) {
                        ...
                        var c = a.method;
                        a.redirect_uri && (h.warn("When using FB.ui, you should not specify a redirect_uri."), delete a.redirect_uri);
                        (c == "permissions.request" || c == "permissions.oauth") && (a.display == "iframe" || a.display == "dialog") && (a.display = m.checkOauthDisplay(a));
                        if (a.display === "native" && c !== "send") {
                            h.error('display type "native" not supported');
                            return null
                        }
                        var d = i("e2e_tracking", !0);
                        d && (a.e2e = {});
                        ...
                        d && a.dialog.subscribe("e2e:end", function (a) {
                            a.method = c, a.display = e, h.debug("e2e: %s", ES("JSON", "stringify", !1, a)), j.log(114, {payload: a})
                        });
                        b(a);
                        return a.dialog
                    }
                ...
                __d("sdk.Canvas.Plugin", ["Log", "sdk.api", "sdk.RPC", "sdk.Runtime", "sdk.UA"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                    ...
                    var o = !(c && c[0] > 10 && c[1] > 10 && (k.chrome() >= 31 || k.webkit() >= 537.71 || k.firefox() >= 25));
                ...
                __d("sdk.Canvas.Prefetcher", ["JSSDKCanvasPrefetcherConfig", "sdk.api", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i) {
                    __p && __p();
                    ...
                    function a() {
                        if (!i.isEnvironment(i.ENVIRONMENTS.CANVAS) || !i.getClientID() || !k) return;
                        if (Math.random() > 1 / k || l == "*" || ~ES(l, "indexOf", !0, i.getClientID())) return;
                        setTimeout(o, 3e4)
                    }
                ...
                __d("legacy:fb.event", ["FB", "sdk.Event", "Log"], (function (a, b, c, d, e, f, g, h, i) {
                    a = function (a) {
                ...
                __d("sdk.MBasicInitializer", ["UrlMap", "sdk.DOM", "sdk.fbt", "sdk.feature", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    __p && __p();
                    var n = function () {
                        __p && __p();
                        ...
                        function a(a) {
                            ...
                            var b = a.parentNode;
                            if (!b) return;
                            var c = h.getAttr(a, "href") || window.location.href, d = new m(g.resolve("m"));
                ...
                __d("sdk.init", ["Log", "ManagedError", "QueryString", "sdk.Cookie", "sdk.ErrorHandling", "sdk.Event", "sdk.MBasicInitializer", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UA", "sdk.URI"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    __p && __p();

                    function r(a) {
                        var b = typeof a === "number" && a > 0 || typeof a === "string" && /^[0-9a-f]{21,}$|^[0-9]{1,21}$/.test(a);
                        if (b) return a.toString();
                        g.warn("Invalid App Id: Must be a number or numeric string representing the application id.");
                        return null
                    }

                    function s(a) {
                        __p && __p();
                        o.getInitialized() && g.warn("FB.init has already been called - this could indicate a problem");
                        if (o.getIsVersioned()) {
                            if (Object.prototype.toString.call(a) !== "[object Object]") throw new h("Invalid argument");
                            a.authResponse && g.warn("Setting authResponse is not supported");
                            a.version || (a.version = new q(location.href).getQueryData().sdk_version);
                            n.assertValidVersion(a.version);
                            o.setVersion(a.version)
                        } else /number|string/.test(typeof a) && (g.warn("FB.init called with invalid parameters"), a = {apiKey: a}), a = ES("Object", "assign", !1, {status: !0}, a || {});
                        var b = r(a.appId || a.apiKey);
                        b !== null && o.setClientID(b);
                        "scope" in a && o.setScope(a.scope);
                        a.cookie && (o.setUseCookie(!0), typeof a.cookie === "string" && j.setDomain(a.cookie));
                    ...
                    setTimeout(function () {
                        ...
                        window.fbAsyncInit && !window.fbAsyncInit.hasRun && (l.fire("init:asyncstart"), window.fbAsyncInit.hasRun = !0, k.unguard(window.fbAsyncInit)())
                    }, 0);
                    e.exports = s
                }), null);
                ...
                __d("sdk.Time", ["Log", "sdk.feature", "sdk.Impressions", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i, j) {
                    "use strict";
                    __p && __p();
                    var k = window.performance, l = k && "now" in k && "getEntriesByName" in k && h("log_perf", !1), m,
                        n = {};
                    if (l) {
                        ...
                        if (a) {
                            ...
                            g.debug("sdkperf: it took %s ms and %s bytes to load %s", parseInt(a.duration, 10), parseInt(a.transferSize, 10), j.getSDKUrl());
                            m = a.startTime;
                            n.ns = j.getSDKNS();
                            b = j.getSDKAB();
                            b && (n.ab = b);
                ...
                __d("XFBML", ["Assert", "Log", "ObservableMixin", "runOnce", "sdk.DOM", "sdk.UA"], (function (a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                    var m = {}, n = {}, o = 0, p = new i();
                    ...
                    function w(a, b, c) {
                        ...
                        var e = 1, f = 0, i = function () {
                            e--, e === 0 && (h.info("XFBML Parsing Finish %s, %s tags found", d, f), b(), p.inform("render", d, f)), g.isTrue(e >= 0, "onrender() has been called too many times")
                        };
                        ES(ES("Array", "from", !1, a.getElementsByTagName("*")), "forEach", !0, function (a) {
                            ...
                            var b = s(a) || t(a);
                            if (!b) return;
                            l.ie() < 9 && a.scopeName && (a = v(a, b.xmlns, b.localName));
                            e++;
                            f++;
                            var d = new b.ctor(a, b.xmlns, b.localName, u(a));
                            d.subscribe("render", j(function () {
                ...
                __d("legacy:fb.xfbml", ["Assert", "sdk.Event", "FB", "XFBML", "sdk.domReady", "wrapFunction"], (function (a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                    i.provide("XFBML", {
                        parse: function (a) {
                    ...
                    h.subscribe("init:post", function (a) {
                        a.xfbml && setTimeout(l(ES(k, "bind", !0, null, j.parse), "entry", "init:post:xfbml.parse"), 0)
                    });
                ...
                __d("IframePlugin", ["Log", "ObservableMixin", "QueryString", "Type", "UrlMap", "guid", "resolveURI", "sdk.Auth", "sdk.createIframe", "sdk.DOM", "sdk.Event", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    __p && __p();
                    var w = {
                        skin: "string",
                        font: "string",
                    ...
                    function B(a, b, c, d) {
                        ES(ES("Object", "keys", !1, a), "forEach", !0, function (e) {
                            a[e] == "text" && !c[e] && (c[e] = b.textContent || b.innerText || "", b.setAttribute(e, c[e])), d[e] = z[a[e]](A(c, e))
                        })
                    }
                        ...
                        constructor: function (a, b, c, d) {
                            ...
                            this.subscribe("xd.resize.flow", ES(function (a) {
                                ES("Object", "assign", !1, this._iframeOptions.root.style, {
                                    ...
                                    overflow: ""
                                }), x(this._iframeOptions.root, C(a.width), C(a.height)), this.updateLift(), clearTimeout(this._timeoutID)
                            }, "bind", !0, this));
                            this.subscribe("xd.resize", ES(function (a) {
                                ES("Object", "assign", !1, this._iframeOptions.root.style, {
                                    verticalAlign: "bottom",
                                    overflow: ""
                                }), x(this._iframeOptions.root, C(a.width), C(a.height)), x(this._iframe, C(a.width), C(a.height)), this._isIframeResized = !0, this.updateLift(), clearTimeout(this._timeoutID)
                            }, "bind", !0, this));
                            this.subscribe("xd.resize.iframe", ES(function (a) {
                                x(this._iframe, C(a.width), C(a.height)), this._isIframeResized = !0, this.updateLift(), clearTimeout(this._timeoutID)
                            }, "bind", !0, this));
                            ...
                            var f = k.resolve("www", !0) + "/plugins/" + c + ".php?", g = {};
                            ...
                            ES("Object", "assign", !1, g, {
                                ...
                                channel: v.handler(ES(function (a) {
                            ...
                            this.subscribe("xd.verify", function (a) {
                                v.sendToFacebook(h, {method: "xd/verify", params: ES("JSON", "stringify", !1, a.token)})
                            });
                            this.subscribe("xd.refreshLoginStatus", ES(function () {
                                n.removeLogoutState(), n.getLoginStatus(ES(this.inform, "bind", !0, this, "login.status"), !0)
                            }, "bind", !0, this));
                            ...
                            this._iframeOptions = {
                                ...
                                url: f + i.encode(g),
                                name: h,
                                width: this._config.mobile_fullsize && t.mobile() ? void 0 : g.width || 1e3,
                                height: g.height || 1e3,
                            ...
                            if (s.getIsVersioned()) {
                                ...
                                this._iframeOptions.url = a.setPath("/" + s.getVersion() + a.getPath()).toString()
                            }
                            a = ES("Object", "assign", !1, {}, this._params);
                            delete a.channel;
                            var b = i.encode(a);
                            if (this._element.getAttribute("fb-iframe-plugin-query") == b) {
                                g.info("Skipping render: %s:%s %s", this._ns, this._tag, b);
                                this.inform("render");
                                return
                            }
                            this._element.setAttribute("fb-iframe-plugin-query", b);
                            this.subscribe("render", ES(function () {
                                q.fire("iframeplugin:onload"), this._iframe.style.visibility = "visible", this._isIframeResized || D(this._iframe)
                            }, "bind", !0, this));
                            ...
                            this._timeoutID = setTimeout(ES(function () {
                                D(this._iframe), g.warn("%s:%s failed to resize in %ss", this._ns, this._tag, c)
                            }, "bind", !0, this), c * 1e3);
                            this._iframe = o(this._iframeOptions);
                            q.fire("iframeplugin:create");
                            if (t.mobile() || a.width === "auto") {
                                this.useInlineHeightForMobile() && p.addCss(this._element, "fb_iframe_widget_fluid");
                                if (!this._iframeOptions.width) {
                                    ...
                                    (t.iphone() || t.ipad()) && ES("Object", "assign", !1, b, {
                                        width: "220px",
                                        "min-width": "100%"
                                    });
                            ...
                            p[a ? "removeCss" : "addCss"](this._iframe, "fb_iframe_widget_lift")
                        }
                    }, h);
                    E.getVal = A;
                ...
                __d("sdk.XFBML.Element", ["ObservableMixin", "Type", "sdk.DOM"], (function (a, b, c, d, e, f, g, h, i) {
                    __p && __p();
                    a = h.extend({
                        constructor: function (a) {
                ...
                __d("sdk.XFBML.IframeWidget", ["QueryString", "UrlMap", "guid", "insertIframe", "sdk.Arbiter", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.Event", "sdk.Runtime", "sdk.ui", "sdk.XD", "sdk.XFBML.Element"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
                    __p && __p();
                    a = s.extend({
                        _iframeName: null,
                        _showLoader: !0,
                        ...
                        getChannelUrl: function () {
                            if (!this._channelUrl) {
                                var a = this;
                                this._channelUrl = r.handler(function (b) {
                                    a.fire("xd." + b.type, b)
                                }, "parent.parent", !0)
                            }
                        ...
                        arbiterInform: function (event, a, b) {
                            r.sendToFacebook(this.getIframeName(), {
                                ...
                                behavior: b || k.BEHAVIOR_PERSISTENT
                            })
                        },
                        ...
                        process: function (a) {
                            ...
                            this._done = !0;
                            this._iframeName = this.getIframeName() || this._iframeName || i();
                            ...
                            this._visibleAfter != "immediate" ? n.addCss(this.dom, "fb_hide_iframes") : this.subscribe("iframe.onload", ES(this.fire, "bind", !0, this, "render"));
                            a = this.getSize() || {};
                            var b = this.getFullyQualifiedURL();
                            a.width == "100%" && n.addCss(this.dom, "fb_iframe_widget_fluid");
                            this.clear();
                            j({
                                url: b,
                            ...
                            this.subscribe("iframe.onload", ES(function () {
                                this.loaded = !0, this._isResizeHandled || n.addCss(this.dom, "fb_hide_iframes")
                            }, "bind", !0, this))
                        },
                        ...
                        _makeVisible: function () {
                            this._removeLoader(), n.removeCss(this.dom, "fb_hide_iframes"), this.fire("render")
                        },
                        _setupAuthRefresh: function () {
                            l.getLoginStatus(ES(function (a) {
                                var b = a.status;
                                o.subscribe("auth.statusChange", ES(function (a) {
                        ...
                        _addLoader: function () {
                            this._loaderDiv || (n.addCss(this.dom, "fb_iframe_widget_loader"), this._loaderDiv = document.createElement("div"), this._loaderDiv.className = "FB_Loader", this.dom.appendChild(this._loaderDiv))
                        },
                        _removeLoader: function () {
                            this._loaderDiv && (n.removeCss(this.dom, "fb_iframe_widget_loader"), this._loaderDiv.parentNode && this._loaderDiv.parentNode.removeChild(this._loaderDiv), this._loaderDiv = null)
                        },
                        _getQS: function () {
                ...
                __d("sdk.XFBML.Comments", ["JSSDKConfig", "QueryString", "UrlMap", "sdk.Event", "sdk.Runtime", "sdk.UA", "sdk.XFBML.IframeWidget"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    __p && __p();
                    var n = 320;
                    a = m.extend({
                        _visibleAfter: "immediate", _refreshOnAuthChange: !0, setupAndValidate: function () {
                            ...
                            g.initSitevars.enableMobileComments && l.mobile() && a.mobile !== !1 && (a.mobile = !0);
                            ...
                            if (!a.href) {
                                ...
                                a.migrated && (a.href = i.resolve("www") + "/plugins/comments_v1.php?app_id=" + k.getClientID() + "&xid=" + encodeURIComponent(a.xid) + "&url=" + encodeURIComponent(a.url))
                            } else {
                                b = this.getAttribute("fb_comment_id");
                                b || (b = h.decode(document.URL.substring(ES(document.URL, "indexOf", !0, "?") + 1)).fb_comment_id, b && ES(b, "indexOf", !0, "#") > 0 && (b = b.substring(0, ES(b, "indexOf", !0, "#"))));
                            ...
                            return i.resolve("www", !0)
                        }
                    });
                    e.exports = a
                }), null);
                __d("sdk.XFBML.CommentsCount", ["ApiClient", "sdk.DOM", "sdk.XFBML.Element", "Log", "sprintf"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                    a = i.extend({
                        process: function () {
                            ...
                            g.scheduleBatchCall("/v2.1/" + encodeURIComponent(a), {fields: "share"}, ES(function (a) {
                                ...
                                h.html(this.dom, k('<span class="fb_comments_count">%s</span>', a));
                ...
                __d("sdk.XFBML.CustomerChat", ["sdk.Content", "sdk.DialogUtils", "sdk.DocumentTitle", "sdk.DOM", "sdk.DOMEventListener", "sdk.Event", "IframePlugin", "QueryString", "sdk.UA", "sdk.XD", "sdk.createIframe", "getDocumentScrollElement"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
                    "use strict";
                    __p && __p();
                    var s = ["animationend", "mozAnimationEnd", "MSAnimationEnd", "oAnimationEnd", "webkitAnimationEnd"],
                        t = null, u = !(o.ie() <= 9), v = null, w = !1, x = null, y = "", z = !1, A = 0, B = 0,
                        C = null;
                    a = m.extend({
                        constructor: function (a, b, c, d) {
                            ...
                            this.subscribe("xd.liveChatPluginGetBubbleIframe", ES(function (a) {
                                ...
                                z = ES("JSON", "parse", !1, a.passesAnimationGK), ES("JSON", "parse", !1, a.isMobile) ? this._handlePrepareMobileAnchorIframe(a) : this._handlePrepareDesktopAnchorIframe(a)
                            ...
                            }, "bind", !0, this)), this.subscribe("xd.liveChatPluginUpdateShadow", ES(function (a) {
                            ...
                            this._bubbleDialog = this._setupNewIframeDialog(a.fromIframe, ES("JSON", "parse", !1, a.isHTTPS)), v = this._bubbleDialog, g.append(this._bubbleDialog), this.subscribe("xd.liveChatPluginShowBubbleIframe", ES(function (a) {
                                j.setStyle(this._bubbleDialog, "display", "inline"), u && z && (j.addCss(this._bubbleDialog, "fb_customer_chat_bubble_pop_in"), ES("JSON", "parse", !1, a.dialogHidden) || setTimeout(ES(function () {
                                    C = !1, F(this._iframe, w, o.mobile(), !1)
                                }, "bind", !0, this), 750)), ES("JSON", "parse", !1, a.showBadge) && this._setBubbleBadgeStyle()
                            }, "bind", !0, this))
                            ...
                            this._iframe && (this._iframe.setAttribute("data-testid", "dialog_iframe"), ES("Object", "assign", !1, this._iframe.style, {
                                ...
                                width: "288pt",
                                zIndex: "2147483647"
                            }), j.setStyle(this._iframe, "maxHeight", ES("JSON", "parse", !1, a.dialogHidden) || u && z ? "0" : "100%"), ES("JSON", "parse", !1, a.chatStarted) && (w = !0, ES("Object", "assign", !1, this._iframe.style, {height: "378pt"})), x = this._iframe)
                        }, _handlePrepareMobileAnchorIframe: function (a) {
                            this._iframe && (this._iframe.setAttribute("data-testid", "dialog_iframe"), ES("Object", "assign", !1, this._iframe.style, {
                                padding: "0",
                                position: "fixed",
                                zIndex: "2147483647"
                            }), j.setStyle(this._iframe, "maxHeight", ES("JSON", "parse", !1, a.dialogHidden) || u && z ? "0" : "100%"), ES("JSON", "parse", !1, a.chatStarted) ? (w = !0, ES("Object", "assign", !1, this._iframe.style, {
                                boxShadow: "none",
                                height: "100%",
                                right: "0",
                                top: "0",
                                width: "100%"
                            }), ES("JSON", "parse", !1, a.dialogHidden) || D()) : ES("Object", "assign", !1, this._iframe.style, {
                                borderRadius: "9pt",
                                bottom: "63pt",
                                right: "3pt",
                                top: "auto",
                            ...
                            w = !0, this._iframe && j.setStyle(this._iframe, "height", "378pt")
                        }, _handleExpandMobileDialogIframe: function () {
                            w = !0, this._iframe && (j.setStyle(this._iframe, "boxShadow", "none"), j.setStyle(this._iframe, "border-radius", "0"), j.setStyle(this._iframe, "height", "100%"), j.setStyle(this._iframe, "right", "0"), j.setStyle(this._iframe, "top", "0"), j.setStyle(this._iframe, "width", "100%")), D()
                        }, _handleShowDialogIframe: function (a) {
                            F(this._iframe, ES("JSON", "parse", !1, a.chatStarted), ES("JSON", "parse", !1, a.isMobile))
                        }, _handleHideDialogIframe: function (a) {
                            G(this._iframe, ES("JSON", "parse", !1, a.chatStarted), ES("JSON", "parse", !1, a.isMobile))
                        }, _handleShadowUpdate: function (a) {
                            ES("JSON", "parse", !1, a.resetShadow) && this._bubbleDialog ? (j.setStyle(this._bubbleDialog, "borderRadius", "50%"), u && z ? j.addCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_no_badge") : j.setStyle(this._bubbleDialog, "boxShadow", "0px 3px 12px rgba(0, 0, 0, 0.15)")) : ES("JSON", "parse", !1, a.resetShadow) || this._setBubbleBadgeStyle()
                            ...
                            u && z ? (j.removeCss(c.dialogElement, "fb_customer_chat_bubble_animated_with_badge"), j.addCss(c.dialogElement, "fb_customer_chat_bubble_animated_no_badge")) : j.setStyle(c.dialogElement, "boxShadow", "0px 3px 12px rgba(0, 0, 0, 0.15)");
                            return c.dialogElement
                        }, _setBubbleBadgeStyle: function () {
                            this._bubbleDialog && (j.setStyle(this._bubbleDialog, "borderRadius", "50% 0% 50% 50%"), u && z ? (j.removeCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_no_badge"), j.addCss(this._bubbleDialog, "fb_customer_chat_bubble_animated_with_badge")) : j.setStyle(this._bubbleDialog, "boxShadow", "-5px 4px 14px rgba(0, 0, 0, 0.15)"))
                    ...
                    function D() {
                        A = window.pageXOffset !== undefined ? window.pageXOffset : document.documentElement && document.documentElement.scrollLeft, B = window.pageYOffset !== undefined ? window.pageYOffset : document.documentElement && document.documentElement.scrollTop, j.addCss(document.body, "fb_mobile_overlay_active")
                    }

                    function E() {
                        j.removeCss(document.body, "fb_mobile_overlay_active"), window.scrollTo(A, B)
                    }
                    ...
                    function F(a, b, c, d) {
                        ...
                        if (C === null || C === !1) {
                            ...
                            if (u) {
                                var e, f;
                                !z ? (e = "fb_customer_chat_bounce_in_v1", f = "fb_customer_chat_bounce_out_v1") : c && b ? (e = "fb_customer_chat_bounce_in_v2_mobile_chat_started", f = "fb_customer_chat_bounce_out_v2_mobile_chat_started") : (e = "fb_customer_chat_bounce_in_v2", f = "fb_customer_chat_bounce_out_v2");
                                j.removeCss(a, f);
                                j.addCss(a, e)
                            }
                            j.setStyle(a, "maxHeight", "100%");
                            C = !0
                        }
                    ...
                    function G(a, b, c, d) {
                        ...
                        if (C === null || C === !0) {
                            c && b && E();
                            if (!u) j.setStyle(e, "maxHeight", "0"); else {
                                var f = function a(d) {
                                    var f;
                                    !z ? f = "fb_bounce_out_v1" : c && b ? f = "fb_bounce_out_v2_mobile_chat_started" : f = "fb_bounce_out_v2";
                                    d.animationName === f && (j.setStyle(e, "maxHeight", "0"), ES(s, "forEach", !0, function (event) {
                                        k.remove(e, event, a)
                                    }))
                                }, g;
                                !z ? (a = "fb_customer_chat_bounce_in_v1", g = "fb_customer_chat_bounce_out_v1") : c && b ? (a = "fb_customer_chat_bounce_in_v2_mobile_chat_started", g = "fb_customer_chat_bounce_out_v2_mobile_chat_started") : (a = "fb_customer_chat_bounce_in_v2", g = "fb_customer_chat_bounce_out_v2");
                                j.removeCss(e, a);
                                j.addCss(e, g);
                    ...
                    a.show = function (a) {
                        a === void 0 && (a = !0), j.setStyle(v, "display", "inline"), a && F(x, w, o.mobile(), !1), l.fire("customerchat.show")
                    };
                    a.hide = function () {
                        j.setStyle(v, "display", "none"), G(x, w, o.mobile(), !1), l.fire("customerchat.hide")
                    };
                    a.showDialog = function () {
                        j.setStyle(v, "display", "inline"), F(x, w, o.mobile())
                    };
                ...
                __d("sdk.Helper", ["UrlMap", "safeEval", "sdk.ErrorHandling", "sdk.Event", "sprintf"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                    a = {
                        isUser: function (a) {
                            ...
                            !c && a && (c = k("%s/profile.php?id=%s", g.resolve("www"), a.uid || a.id));
                            c && (b = k('<a class="fb_link" href="%s">%s</a>', c, b));
                            return b
                        }, invokeHandler: function (a, b, c) {
                            a && (typeof a === "string" ? i.unguard(h)(a, c) : a.apply && i.unguard(a).apply(b, c || []))
                ...
                __d("sdk.XFBML.LoginButton", ["IframePlugin", "Log", "sdk.Helper", "sdk.ui", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                    a = g.extend({
                        constructor: function (a, b, c, d) {
                            __p && __p();
                            this.parent(a, b, c, d);
                            var e = g.getVal(d, "on_login"), f = null, l = this._iframeOptions.name;
                            e && (f = function (a) {
                                if (a.error_code) {
                                    h.debug("Plugin Return Error (%s): %s", a.error_code, a.error_message || a.error_description);
                                    return
                                }
                                i.invokeHandler(e, null, [a])
                            }, this.subscribe("login.status", f));
                            this.subscribe("xd.login_button_dialog_open", function (a) {
                                j(ES("JSON", "parse", !1, a.params), function (a) {
                                    i.invokeHandler(f, null, [a]), k.sendToFacebook(l, {
                                        method: "loginReload",
                                        params: ES("JSON", "stringify", !1, a)
                                    })
                                })
                ...
                __d("sdk.XFBML.Name", ["ApiClient", "Log", "escapeHTML", "sdk.Event", "sdk.Helper", "sdk.Runtime", "sdk.Scribe", "sdk.XFBML.Element"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    __p && __p();
                    ...
                    a = n.extend({
                        process: function () {
                            ...
                            m.log("jssdk_error", {appId: l.getClientID(), error: "<fb:name>"});
                            ...
                            this._subjectId && (a.push("gender"), this._subjectId == l.getUserID() && (this._reflexive = !0));
                            j.monitor("auth.statusChange", ES(function () {
                                ...
                                (!this._uid || this._uid == "loggedinuser") && (this._uid = l.getUserID());
                                if (!this._uid) return;
                                g.scheduleBatchCall("/v1.0/" + this._uid, {fields: a.join(",")}, ES(function (a) {
                                    if (o.call(a, "error")) {
                                        h.warn("The name is not found for ID: " + this._uid);
                                        return
                                    }
                            ...
                            if (this._uid == l.getUserID() && this._getBoolAttribute("use-you", !0)) this._possessive ? this._reflexive ? b = "your own" : b = "your" : this._reflexive ? b = "yourself" : b = "you"; else switch (a.gender) {
                                case"male":
                            ...
                            var b = "", c = "";
                            this._uid == l.getUserID() && this._getBoolAttribute("use-you", !0) ? this._reflexive ? this._possessive ? b = "your own" : b = "yourself" : this._possessive ? b = "your" : b = "you" : a && (null === a.first_name && (a.first_name = ""), null === a.last_name && (a.last_name = ""), this._firstnameonly && a.first_name !== undefined ? b = i(a.first_name) : this._lastnameonly && a.last_name !== undefined && (b = i(a.last_name)), b || (b = i(a.name)), b !== "" && this._possessive && (b += "'s"));
                            b || (b = i(this.getAttribute("if-cant-see", "Facebook User")));
                ...
                __d("sdk.XFBML.Quote", ["IframePlugin", "UnicodeUtils", "containsNode", "sdk.DOM", "sdk.DOMEventListener", "sdk.feature", "sdk.UA", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    "use strict";
                    __p && __p();
                    var o = "fb-quotable", p = 155, q = 70, r = "", s = null, t = [], u = !1, v = null, w = m.mobile();
                    ...
                    function y(a) {
                        ...
                        if (b) {
                            var c = !1;
                            for (var d = 0; d < b; d++) if (i(t[d], a.focusNode)) {
                                c = !0;
                                break
                            }
                            if (!c) return
                        ...
                        h.strlen(r) > b ? r = h.substr(r, 0, b - 3) + "..." : r = h.substr(r, 0, b);
                        if (!u && v) {
                            x(a).appendChild(v);
                            d = z(a);
                            v.style.left = d.x + "px";
                    ...
                    a = g.extend({
                        constructor: function (a, b, c, d) {
                            ...
                            t = ES(ES("Array", "from", !1, document.getElementsByTagName("*")), "filter", !0, function (a) {
                                return a.nodeName.toLowerCase() === "article" || j.containsCss(a, o)
                            });
                            A();
                            s = this;
                            return s
                ...
                __d("sdk.XFBML.Save", ["IframePlugin", "QueryString", "sdk.Content", "sdk.createIframe", "sdk.DialogUtils", "sdk.DOM", "sdk.Event", "sdk.UA", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    "use strict";
                    __p && __p();
                    var p;
                    a = g.extend({
                        constructor: function (a, b, c, d) {
                            ...
                            this.subscribe("xd.savePluginGetBlankIframe", ES(function (a) {
                                __p && __p();
                                var b, c, d, f = function (a) {
                                    a && l.removeCss(a, "fb_invisible")
                                }, g = function (a) {
                                    a && l.addCss(a, "fb_invisible")
                                };
                                e && (b = k.setupNewDarkOverlay(), g(b), i.append(b), k.addDoubleClickAction(b, function () {
                                ...
                                d = [c, b];
                                var h = function () {
                                    ES(d, "forEach", !0, g), k.onDialogHideCleanup(e), clearInterval(p)
                                }, j;
                                this.subscribe("xd.savePluginShowIframe", ES(function () {
                                    m.fire("savePlugin:hideDialog"), ES(d, "forEach", !0, f), this.positionOnScreen(c, b), !e && !j && (j = k.addIdleDesktopAction(c, h, 7e3))
                                }, "bind", !0, this));
                                ...
                                var n = setInterval(function () {
                                    ...
                                    b.length === 0 && (clearInterval(n), h(), ES(d, "forEach", !0, function (a) {
                            ...
                            if (c) {
                                var d = function (a, b) {
                                    b != null && k.setDialogPositionToCenter(b, c), k.setDialogPositionToCenter(a, c)
                                };
                                d(a, b);
                            ...
                            } else l.setStyle(a, "position", "fixed"), l.setStyle(a, "top", "20px"), l.setStyle(a, "right", "20px")
                        }, setupNewIframeDialog: function (a, b, c) {
                            __p && __p();
                            b = "#" + h.encode({forIframe: b});
                            var d = k.setupNewDialog();
                            j({
                                url: o.getXDArbiterURL(c) + b,
                                name: "blank_" + this._iframeOptions.name,
                                root: d.contentRoot,
                                tabindex: -1
                            });
                            l.addCss(d.contentRoot, "fb_dialog_iframe");
                            ES("Object", "assign", !1, d.dialogElement.style, a.style || {});
                            l.setStyle(d.dialogElement, "width", a.width + "px");
                            l.setStyle(d.dialogElement, "height", a.height + "px");
                            ES(a.classList, "forEach", !0, function (a) {
                                return l.addCss(d.dialogElement, a)
                            });
                            l.removeCss(d.dialogElement, "fb_dialog_advanced");
                ...
                __d("sdk.XFBML.Video", ["Assert", "IframePlugin", "ObservableMixin", "sdk.Event", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                    ...
                    a = h.extend({
                        constructor: function (a, b, c, d) {
                            this.parent(a, b, c, d), this._videoController = null, this._sharedObservable = null, this._sharedVideoCache = null, this.subscribe("xd.onVideoAPIReady", function (a) {
                                this._sharedObservable = new i(), this._sharedVideoCache = new l(ES("JSON", "parse", !1, a.data)), this._videoController = new m(this._iframeOptions.name, this._sharedObservable, this._sharedVideoCache), j.fire("xfbml.ready", {
                                    type: "video",
                                    id: d.id,
    ...
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"4047105","namespace":"FB","message":"' + e.message + '"}}');
}